    ...
    internal class EventManager
    {
        ...
        internal class FetchAllResponse : BaseReferenceHolder
        {
            ...
            internal List<NativeEvent> Data()
            {
                ...
                return PInvokeUtilities.OutParamsToArray<IntPtr>((out_arg, out_size) => GooglePlayGames.Native.Cwrapper.EventManager.EventManager_FetchAllResponse_GetData(base.SelfPtr(), out_arg, out_size)).Select<IntPtr, NativeEvent>(<>f__am$cache0).ToList<NativeEvent>();
            }
            ...
            internal GooglePlayGames.Native.Cwrapper.CommonErrorStatus.ResponseStatus ResponseStatus() => 
                GooglePlayGames.Native.Cwrapper.EventManager.EventManager_FetchAllResponse_GetStatus(base.SelfPtr());
        }
        ...
        internal class FetchResponse : BaseReferenceHolder
        {
            ...
            internal GooglePlayGames.Native.Cwrapper.CommonErrorStatus.ResponseStatus ResponseStatus() => 
                GooglePlayGames.Native.Cwrapper.EventManager.EventManager_FetchResponse_GetStatus(base.SelfPtr());
        }
    }
}
