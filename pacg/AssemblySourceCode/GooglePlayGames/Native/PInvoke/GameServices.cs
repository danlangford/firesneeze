    ...
    internal class GameServices : BaseReferenceHolder
    {
        ...
        internal class FetchServerAuthCodeResponse : BaseReferenceHolder
        {
            ...
            internal string Code() => 
                PInvokeUtilities.OutParamsToString((out_string, out_size) => GooglePlayGames.Native.Cwrapper.GameServices.GameServices_FetchServerAuthCodeResponse_GetCode(base.SelfPtr(), out_string, out_size));
            ...
            internal GooglePlayGames.Native.Cwrapper.CommonErrorStatus.ResponseStatus Status() => 
                GooglePlayGames.Native.Cwrapper.GameServices.GameServices_FetchServerAuthCodeResponse_GetStatus(base.SelfPtr());
        }
    }
}
