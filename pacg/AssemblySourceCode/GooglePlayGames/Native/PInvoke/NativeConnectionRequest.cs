namespace GooglePlayGames.Native.PInvoke
{
    ...
    internal class NativeConnectionRequest : BaseReferenceHolder
    {
        ...
        internal ConnectionRequest AsRequest() => 
            new ConnectionRequest(this.RemoteEndpointId(), this.RemoteDeviceId(), this.RemoteEndpointName(), NearbyConnectionsManager.ServiceId, this.Payload());
        ...
        internal string RemoteDeviceId() => 
            PInvokeUtilities.OutParamsToString((out_arg, out_size) => NearbyConnectionTypes.ConnectionRequest_GetRemoteDeviceId(base.SelfPtr(), out_arg, out_size));
