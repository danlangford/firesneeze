namespace GooglePlayGames.Native.PInvoke
{
    ...
    internal static class PInvokeUtilities
    {
        ...
        internal static IEnumerable<T> ToEnumerable<T>(UIntPtr size, Func<UIntPtr, T> getElement) => 
            new <ToEnumerable>c__Iterator2<T> { 
                size = size,
        ...
        [CompilerGenerated]
        private sealed class <ToEnumerable>c__Iterator2<T> : IDisposable, IEnumerator, IEnumerable, IEnumerable<T>, IEnumerator<T>
        {
            internal T $current;
            internal int $PC;
            ...
            IEnumerator<T> IEnumerable<T>.GetEnumerator()
            {
                ...
                return new PInvokeUtilities.<ToEnumerable>c__Iterator2<T> { 
                    size = this.<$>size,
