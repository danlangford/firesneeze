    ...
    internal class QuestManager
    {
        ...
        internal class AcceptResponse : BaseReferenceHolder
        {
            ...
            internal bool RequestSucceeded() => 
                (this.ResponseStatus() > ~(GooglePlayGames.Native.Cwrapper.CommonErrorStatus.QuestAcceptStatus.VALID | GooglePlayGames.Native.Cwrapper.CommonErrorStatus.QuestAcceptStatus.ERROR_INTERNAL));

            internal GooglePlayGames.Native.Cwrapper.CommonErrorStatus.QuestAcceptStatus ResponseStatus() => 
                GooglePlayGames.Native.Cwrapper.QuestManager.QuestManager_AcceptResponse_GetStatus(base.SelfPtr());
        }
        ...
        internal class ClaimMilestoneResponse : BaseReferenceHolder
        {
            ...
            internal bool RequestSucceeded() => 
                (this.ResponseStatus() > ~(GooglePlayGames.Native.Cwrapper.CommonErrorStatus.QuestClaimMilestoneStatus.VALID | GooglePlayGames.Native.Cwrapper.CommonErrorStatus.QuestClaimMilestoneStatus.ERROR_INTERNAL));

            internal GooglePlayGames.Native.Cwrapper.CommonErrorStatus.QuestClaimMilestoneStatus ResponseStatus() => 
                GooglePlayGames.Native.Cwrapper.QuestManager.QuestManager_ClaimMilestoneResponse_GetStatus(base.SelfPtr());
        }
        ...
        internal class FetchListResponse : BaseReferenceHolder
        {
            ...
            internal IEnumerable<NativeQuest> Data() => 
                PInvokeUtilities.ToEnumerable<NativeQuest>(GooglePlayGames.Native.Cwrapper.QuestManager.QuestManager_FetchListResponse_GetData_Length(base.SelfPtr()), index => new NativeQuest(GooglePlayGames.Native.Cwrapper.QuestManager.QuestManager_FetchListResponse_GetData_GetElement(base.SelfPtr(), index)));
            ...
            internal GooglePlayGames.Native.Cwrapper.CommonErrorStatus.ResponseStatus ResponseStatus() => 
                GooglePlayGames.Native.Cwrapper.QuestManager.QuestManager_FetchListResponse_GetStatus(base.SelfPtr());
        }
        ...
        internal class FetchResponse : BaseReferenceHolder
        {
            ...
            internal GooglePlayGames.Native.Cwrapper.CommonErrorStatus.ResponseStatus ResponseStatus() => 
                GooglePlayGames.Native.Cwrapper.QuestManager.QuestManager_FetchResponse_GetStatus(base.SelfPtr());
        }
        ...
        internal class QuestUIResponse : BaseReferenceHolder
        {
            ...
            internal GooglePlayGames.Native.Cwrapper.CommonErrorStatus.UIStatus RequestStatus() => 
                GooglePlayGames.Native.Cwrapper.QuestManager.QuestManager_QuestUIResponse_GetStatus(base.SelfPtr());
