namespace GooglePlayGames.Native.PInvoke
{
    ...
    internal class NativeEndpointDetails : BaseReferenceHolder
    {
        ...
        internal string DeviceId() => 
            PInvokeUtilities.OutParamsToString((out_arg, out_size) => NearbyConnectionTypes.EndpointDetails_GetDeviceId(base.SelfPtr(), out_arg, out_size));
        ...
        internal EndpointDetails ToDetails() => 
            new EndpointDetails(this.EndpointId(), this.DeviceId(), this.Name(), this.ServiceId());
    }
}
