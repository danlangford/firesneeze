namespace GooglePlayGames.Native.PInvoke
{
    ...
    internal class PlayerManager
    {
        ...
        [CompilerGenerated]
        private sealed class <FetchFriends>c__AnonStorey11B
        {
            ...
            internal void <>m__DA(GooglePlayGames.Native.PInvoke.PlayerManager.FetchListResponse rsp)
            {
        ...
        [CompilerGenerated]
        private sealed class <FetchList>c__AnonStorey11A
        {
            internal GooglePlayGames.Native.PInvoke.PlayerManager <>f__this;
            internal GooglePlayGames.Native.PInvoke.PlayerManager.FetchResponseCollector coll;

            internal void <>m__D9(GooglePlayGames.Native.PInvoke.PlayerManager.FetchResponse rsp)
            {
