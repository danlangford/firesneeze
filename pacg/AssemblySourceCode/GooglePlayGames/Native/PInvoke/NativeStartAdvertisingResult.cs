namespace GooglePlayGames.Native.PInvoke
{
    ...
    internal class NativeStartAdvertisingResult : BaseReferenceHolder
    {
        ...
        internal AdvertisingResult AsResult() => 
            new AdvertisingResult((GooglePlayGames.BasicApi.ResponseStatus) ((int) Enum.ToObject(typeof(GooglePlayGames.BasicApi.ResponseStatus), this.GetStatus())), this.LocalEndpointName());
